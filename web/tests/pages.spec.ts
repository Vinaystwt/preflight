...
for (const size of [{n:"1440",w:1440,h:1000},{n:"375",w:375,h:812}]) {
  test.describe(`pages ${size.n}`, () => {
    ...
    for (const [route,name] of [["/","home"],["/check","check-idle"],["/how-it-works","how"],["/pricing","pricing"],["/docs","docs"],["/demo","demo"],["/gallery","gallery"],["/cli","cli"],["/legal/privacy","privacy"]] as const) {
